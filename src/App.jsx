...
const BUSINESSES = [
  ...
  { id: 75, name: "אביב רפאלי נחמני – מטפל בחרדות", cat: "בריאות ורפואה", tel: "053-420-5110", hours: "",              addr: "רימון 27, באר גנים",       site: "https://rafaelnlp.com", ig: "https://www.instagram.com/avivnahmani", fb: "", tiktok: "https://www.tiktok.com/@avivrefaelinahmani", desc: "מטפל בחרדות ובטראומה" },
        ...
        <div className="ex">
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: 7, marginTop: 13 }}>
            ...
            {biz.fb && biz.fb.startsWith("http") && (
              <a href={biz.fb} target="_blank" rel="noreferrer" className="ab o" onClick={e => e.stopPropagation()} style={{ color: biz.fb.includes("wa.me") ? "#16a34a" : "#1877f2", borderColor: biz.fb.includes("wa.me") ? "#bbf7d0" : "#bfdbfe" }}>{biz.fb.includes("wa.me") ? "💬 וואטסאפ" : "📘 פייסבוק"}</a>
            )}
